...
Sekä käyttöliittymä että ohjelmointirajapinnat tiedostojärjestelmien kuuluukin nykyisten käyttöjärjestelmien perustoiminnallisuuksin.
...
kuten esimerkiksi SQL-tietokannat käyttävät usein tiedostojärjestelmää raakojen levykirjoitusten sijaan.
}
