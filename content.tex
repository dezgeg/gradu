...
%inode=12 rec_len=12 name_len=1 name="." sekä 3 0-tavua.
%inode=2 rec_len=12 name_len=2 name=".." sekä 2 0-tavua.
%inode=13 rec_len=12 name_len=3 name="abc" sekä 1 0-tavu.
%inode=14 rec_len=20 name_len=11 name="defghijklmn" sekä 1 0-tavu.
%inode=15 rec_len=968 name_len=12 name="opqrstuvwxyz" sekä loput lohkosta ovat 0-tavuja.

Nyt poistettaessa tiedosto \texttt{defghijklmn} muuttuu kolmannen alkion sisällöksi:
%inode=13 rec_len=20 name_len=3 name="abc" sekä roskaa.
