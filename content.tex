...
Kohdat 4--5 päivittävät rollback journalin otsakkeeseen, että sen kirjoitus on suoritettu loppuun.
Kohdassa 6 tehdään muutokset itse tietokantaan.
...
Tällaisia tilanteita varten lähes jokaiseen tiedostojärjestelmätoteutukseen kuuluukin tyypillisesti \emph{fsck (file system check)}-niminen tarkastusohjelma joka pyrkii tarkistamaan koko tiedostojärjestelmän metadatan oikeellisuuden ja tarvittaessa korjaamaan kohdattuja ongelmia.
...
Koska jokaisella tiedostojärjestelmällä on oma levyformaattinsa jotka voivat korruptoitua eri tavoilla,
tarvitaan jokaiselle niistä oma työkalu tiedostojärjestelmän konsistenssiuden tarkistamiselle.
