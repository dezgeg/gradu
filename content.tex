...
Tutkittavia persistenssiominaisuuksia ovat:
\begin{itemize}
    \item{Tiedoston olemassaolevan sisällön ylikirjoitus \texttt{write()}-kutsulla atomisuus.}
    \item{Sisällön lisääminen tiedoston loppuun \texttt{write()}-kutsulla.}
    \item{Hakemisto-operaatioiden, kuten \texttt{link()}, \texttt{unlink()} ja \texttt{rename()} atomisuus.}
\end{itemize}
