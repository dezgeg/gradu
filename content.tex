...
Taulukossa~\ref{TabAppVulnerabilities} nähdään artikkelin testaamien tietokantasovellusten sisältämien kaatumishaavoittuvuuksien määrän kolmella eri Linux-tiedostojärjestelmällä.
