...
Edellisen luvun esimerkistä nähtiin että yksinkertaisenkin koostetun tiedostojärjestelmäoperaation toteuttaminen kaatumisturvallisesti on verrattaen haastavaa,
koska POSIX tarjoaa tiedostojärjestelmätoteutuksille merkittävät vapaudet uudelleenjärjestellä tai lykätä levykirjoitusten tekemistä ellei sitä erikseen pakoteta \texttt{fsync()}- tai \texttt{fdatasync()}-kutsuja käyttämällä.
Herääkin kysymys, että ovatko tiedostojärjestelmää käyttävät sovellukset ottaneet nämä seikat huomioon vai onko niiden kaatumisturvallisuudessa puutteita.
Toisaalta, vaikka POSIX spesifikaationa salliikin tiedostojärjestelmätoteutuksille paljon vapauksia,
eivät kaikki tiedostojärjestelmätoteutukset välttämättä hyödynnä kaikkia niistä.
