...
FFS-tiedostojärjestelmän kaatumisturvallisuutta alettiin parantamaan BSD-käyttöjärjestelmän versiosta 4.4 lähtien \emph{pehmeitä päivityksiä} käyttämällä.
