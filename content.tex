...
\begin{enumerate}
    ...
    \item{Vasta 30 sekuntia myöhemmin aletaan päivittämään varsinaisia levytietorakenteita:}
        % 0: superlohko
        % 1: lohkoryhmien kuvaajasta vähennetään vapaiden inodejen ja lohkojen määrää
        % 2: lohkobittikarttaan merkitään newfile:en kirjoitetut datalohkot 9216--9231 sekä epäsuora lohko 8722 varatuksi
        % 3: inodebittikarttaan merkitään newfile:lle varattu inode käytössä olevaksi
        % 4: inodetaulu
        % 516: juurihakemiston datalohkoon lisätään uusi hakemistoalkio newfile:lle
        % 8722: epäsuora lohko
\end{enumerate}
...
\begin{itemize}
    \item{\texttt{newfile}:n inode täytyy kirjoittaa ennen juurihakemiston lohkoa, jotta hakemistoalkio \texttt{newfile} ei osoita vapaaseen inodeen.}
    \item{inodebittikartta täytyy kirjoittaa ennen juurihakemiston lohkoa, jotta hakemistoalkio \texttt{newfile} ei osoita bittikartassa varaamattomaan inodeen.}
    \item{juurihakemiston lohko täytyy kirjoittaa ennen \texttt{oldfile}:n inodea, jotta hakemistoalkio \texttt{oldfile} ei osoita vapautettuun inodeen.}
    \item{juurihakemiston lohko täytyy kirjoittaa ennen inodebittikarttaa, jotta hakemistoalkio \texttt{oldfile} ei osoita bittikartassa vapautettuun inodeen.}
\end{itemize}
% init state: /oldfile
% - creat(/newfile)
% - unlink(/oldfile)
