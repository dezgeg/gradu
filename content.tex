...
joista seuraavaksi tarkastellaan \emph{pehmeitä päivityksiä} (\emph{soft updates}) jotka perustuvat metadatakirjoitusten tekemiseen tietyssä järjestyksessä.
Yksikään Linuxin tukema tiedostojärjestelmä ei käytä pehmeitä päivityksiä,
joten tarkastelun kohteena on BSD 4.4-käyttöjärjestelmästä löytyvä Berkeley Fast Filestem-tiedostojärjestelmä~\cite{SoftUpdatesFfs}.
