...
Tässä tutkielmassa tarkastellaan erityisesti Unix-tyyppisiä tiedostojärjestelmiä ja rajapintoja jotka on määritelty POSIX-standardissa.
...
POSIX-tiedostojärjestelmäkutsujen käyttö kaatumisturvallisesti ei ole täysin suoraviivaista,
vaan sovellusohjelmoijan täytyy käytännössä aina tehdä erityistoimenpiteitä jotta kokonaisuudesta tulee kaatumisturvallinen.
Toisaalta itse tiedostojärjestelmätoteutuksen täytyy huolehtia siitä että tiedostojärjestelmän sisäisiä tietorakenteita päivitetään kaatumisturvallisesti ja että toteutus pystyy täyttämään POSIX-standardin asettamat vaatimukset joihin sovellukset luottavat.
...
luvussa~\ref{ChapUnixFsBasics} tarkastellaan Unix-tiedostojärjestelmärajapintojen perusteita ja luvussa~\ref{ChapPosixDataConsistency} kuinka niitä tulisi käyttää kaatumisturvallisuuden takaamiseksi.
...
\section{POSIX-rajapintojen käyttö kaatumisturvallisesti}
...
\begin{itemize}
    \item{Tiedoston olemassaolevan sisällön ylikirjoitus \texttt{write()}-kutsulla.}
    \item{Sisällön lisääminen tiedoston loppuun \texttt{write()}-kutsulla.}
