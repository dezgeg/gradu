...
Tässä luvussa kuitenkin tarkastellaan pääosin ext3:n toteutusta kirjauksesta.
...
Edellisessä luvussa nähtiin kuinka tiedostojärjestelmään voidaan tehdä muutoksia kaatumisturvallisesti ja atomisesti kirjoittamalla uusi tarkistuspiste.
