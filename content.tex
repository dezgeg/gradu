...
Nimen lisäksi kaikilla tiedostoilla ja hakemistoilla on jonkin verran metadataa tiedoston käyttöoikeuksille sekä valvomaan tiedoston käyttöä.
Ensinnäkin jokaiselle tiedostolle tai hakemistolle on tallennettu sen omistavan käyttäjän tunnus (\emph{user id, UID}) sekä ryhmän tunnus (\emph{group id, GID}).
