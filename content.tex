...
Esimerkiksi Microsoft on vuosien saatossa vaihtanut Windows-käyttöjärjestelmän oletustiedostojärjestelmän FAT:sta NTFS:ään,
% FIXME lähde
...
eivät antaneet juuri mitään valmiuksia sille että tiedostojärjestelmän eheys säilyisi \emph{kaatumistilanteissa}.
...
Tämänkaltaiset rajoitukset olleet historiaa jo varsin pitkään modernimmissa tiedostojärjestelmissä,
kuten Linuxin ext3:ssa jo vuodesta 2001 lähtien.
...
on pantava merkille ettei ole olemassa mitään yhtä oikeaa määritelmää tiedostojärjestelmille
...
Nykypäivän Unix-käyttöjärjestelmiä yhdistää merkittävästi \emph{POSIX (Portable Operating System Interface for uniX)}-standardi~\cite{PosixSpec}.
