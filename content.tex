...
Edellisissä luvuissa esiteltiin tekniikoita jossa tiedostojärjestelmän konsistenssiuden säilyminen kaatumistilanteessa toteutettiin tuomalla tiedostojärjestelmään menetelmä atomisten päivitysten tekemiseen.
Tässä luvussa tarkastellaan vaihtoehtoista \emph{pehmeät päivitykset} (\emph{soft updates})-tekniikkaa,
ja erityisesti sen toteutusta Berkeley Fast Filesystem (FFS)-tiedosto\-järjestelmään~\cite{SoftUpdatesFfs}.
