...
\begin{tabular}{l | l | l | l | p{7cm}}
    ...
    4  & 30.847   & +0.000   & 3   & Lohkoryhmän 0 inodebittikartta: merkitään inode \texttt{new} varatuksi \\ \hline % 2
    5  & 30.847   & +0.000   & 516 & Juurihakemisto: lisätään hakemistoalkio \texttt{new}                 \\ \hline % 1
    6  & 61.567   & +30.721  & 4   & Lohkoryhmän 0 inodetaulu: alustetaan inoden \texttt{new} attribuutit \\        % 4
\end{tabular}
...
\begin{tabular}{l | l | l | l | p{7cm}}
    ...
    5  & 5.226    & +5.198   & 1          & Lohkoryhmien kuvaajat: vapaiden lohkojen määrää vähennetään          \\ \hline % 1
    6  & 5.226    & +0.000   & 4          & Lohkoryhmän 0 inodetaulu: inoden \texttt{new} attribuutit päivitetään ...      \\ \hline % 2
    7  & 5.226    & +0.000   & 8192 -- 8208 & Tiedoston \texttt{new} datalohkot sekä yksi epäsuora lohko                               \\        % 3
\end{tabular}
\caption{Olemassaolevan tiedostoon lisäyksestä seuraavat levyoperaatiot.}
\end{table}
...
Superlohkoa lukuunottamatta kaikki Btrfs-tiedostojärjestelmän metadata sijaitsee levyllä B-puuhun pohjautuvassa tietorakenteessa.
