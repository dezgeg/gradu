...
Tässä luvussa tarkastellaan \emph{kirjaavia} (\emph{journalling}) tiedostojärjestelmiä yleisesti,
sekä läheisemmin ext2:n seuraajaa ext3:a.
...
Aiemmissa kappaleissa käsitellyt ext2 ja Berkeley FFS ovat niin sanottuja päälle kirjoittavia (``in-place'') tiedostojärjestelmiä.
Esimerkiksi aiemmin ext2:n yhteydessä nähtiin kuinka metadat
