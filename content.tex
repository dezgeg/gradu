\section{Johdanto}
Tiedostojärjestelmät ovat olleet jo tovin se pääasiallinen tapa jolla sekä käyttäjät että sovellukset voivat käsitellä tietokoneen pysyväismuistia.
...
Aiemmissa kappaleissa käsitellyt ext2/ext3 ja Berkeley FFS ovat niin sanottuja päälle kirjoittavia (\emph{``in-place''}) tiedostojärjestelmiä.
Esimerkiksi aiemmin ext2:n yhteydessä nähtiin kuinka olemassaolevaa tiedostoa uudelleennimettäessä
...
Lisäksi ext3:n kanssa kopiot molemmista kirjoitetaan journaliin.
