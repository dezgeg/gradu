...
\begin{tabular}{r||c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c}
    & \hdr{ext2} & \hdr{ext2-sync} & \hdr{ext3-writeback} & \hdr{ext3-ordered} & \hdr{ext3-datajournal} & \hdr{ext4-writeback} & \hdr{ext4-ordered} & \hdr{ext4-nodelalloc} & \hdr{ext4-datajournal} & \hdr{btrfs} & \hdr{xfs} & \hdr{xfs-wsync} & \hdr{reiserfs-nolog} & \hdr{reiserfs-writeback} & \hdr{reiserfs-ordered} & \hdr{reiserfs-datajournal} \\ \hline \hline
    ylikirjoitus                                                   & \no  & \yes & \no  & \no  & \yes & \no  & \no  & \no  & \yes & \yes & \no  & \no  & \no  & \no  & \no  & \yes \\
    lisäys+uudelleennimeys                                         & \no  & \yes & \no  & \yes & \yes & \no  & \yes & \yes & \yes & \yes & \yes & \yes & \no  & \no  & \yes & \yes \\
    \texttt{O\_TRUNC}+lisäys                                       & \no  & \yes & \no  & \yes & \yes & \no  & \yes & \yes & \yes & \yes & \yes & \yes & \no  & \no  & \yes & \yes \\
    lisäys saman tiedoston sisällä                  & \no  & \yes & \no  & \yes & \yes & \no  & \yes & \yes & \yes & \yes & \yes & \yes & \no  & \no  & \yes & \yes \\
...
Edellisessä luvussa käytiin lävitse \texttt{ext2}:n levytietorakenteiden toiminta teoriatasolla.
...
%  ctime: 0x5ba8fc96:00000000 -- Mon Sep 24 18:02:46 2018
%  atime: 0x5ba8fc96:00000000 -- Mon Sep 24 18:02:46 2018
%  mtime: 0x5ba8fc96:00000000 -- Mon Sep 24 18:02:46 2018
...
% debugfs 1.44.1 (24-Mar-2018)
% debugfs:  istat <12>
% debugfs: Unknown request "istat".  Type "?" for a request list.
% debugfs:  stat <12>
