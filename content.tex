...
Thompson ja Ritchie eivät olleet tyytyväisiä tilanteeseen vaan alkoivat kehittää omaa MULTICSin insipiroimaa käyttöjärjestelmää PDP-7-tietokoneelle~\cite{UnixFsBook}.
Vuonna XYZ Unix oli jo täysin omavarainen,
eli
eli Unixin kehitystä pystyttiin
käyttöjärjestelmän ydin sisältäen usean prosessin tuen sekä tiedostojärjestelmän, komentotulkki sekä peruskomentoja sekä konekielien assembler.
