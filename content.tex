...
Erityisesti lokin 'keskellä' olevien lohkojen sisältöä ei koskaan muokata.

\subsection{Sprinte LFS:n levyrakenne}
Sprite LFS:sä seuraavat tietorakenteet sijaitsevat lokissa:
\begin{itemize}
    \item{inodelohko: samoin kuten ext2:ssa}
    \item{epäsuora lohko: samoin kuten ext2:ssa}
\end{itemize}
