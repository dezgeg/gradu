...
Toinen osuus ``All File Systems Are Not Created Equal: On the Complexity of Crafting Crash-consistent Applications''\cite{PosixDataConsistency}-artikkelista käsitteleekin sovellusten päivitysprotokollien kaatumisturvallisuutta.

\subsection{Esimerkki SQLite-tietokannan päivitysprotokollasta}

Yksi artikkelin tutkimista sovelluksista on SQLite-tietokantakirjasto,
...
Kohdissa 3 ja 4 pakotetaan peruutuslokin sekä peruutuslokitiedostoon viittaavan hakemistoalkion kirjoitus levylle.
...
on itse tietokanta konsistentissa tilassa ja palautumiseen riittää ainoastaan poistaa mahdollinen osittain kirjoitettu peruutusloki.
Muuten palautetaan tietokanta konsistentiksi peruutuslokin sisällön perusteella.
