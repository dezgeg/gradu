...
\begin{enumerate}
    ...
    \item{inodebittikartan lohko täytyy kirjoittaa ennen hakemistolohkoa, jotta \texttt{newfile}:n hakemistoalkio ei osoita bittikartassa vapaaksi merkittyyn inodeen.}
    ...
    \item{hakemistolohko täytyy kirjoittaa ennen inodebittikartan lohkoa, jotta \texttt{oldfile}:n hakemistoalkio ei osoita bittikartassa vapaaksi merkittyyn inodeen.}
\end{enumerate}
